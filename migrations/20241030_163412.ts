...
export async function up({ payload, req }: MigrateUpArgs): Promise<void> {
  ...
  ALTER TABLE "pages_rels" ADD COLUMN "grants_id" integer;
  DO $$ BEGIN
...
export async function down({ payload, req }: MigrateDownArgs): Promise<void> {
  ...
  ALTER TABLE "pages_rels" DROP CONSTRAINT "pages_rels_grants_fk";
  
  DROP INDEX IF EXISTS "pages_rels_grants_id_idx";
  ALTER TABLE "pages_rels" DROP COLUMN IF EXISTS "grants_id";`)
}
