...
export async function up({ payload, req }: MigrateUpArgs): Promise<void> {
  await payload.db.drizzle.execute(sql`
   ALTER TYPE "public"."enum_pages_page_template" ADD VALUE 'fullWidth' BEFORE 'team';
...
export async function down({ payload, req }: MigrateDownArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_pages_page_template" AS ENUM('default', 'devHub', 'events', 'team', 'wallets', 'grants');
