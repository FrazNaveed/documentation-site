...
export async function up({ payload, req }: MigrateUpArgs): Promise<void> {
  await payload.db.drizzle.execute(sql`
   DROP TABLE "pages_blocks_table_drawers_sections_rows" CASCADE;
  DROP TABLE "pages_blocks_table_drawers_sections" CASCADE;
  DROP TABLE "pages_blocks_table_drawers" CASCADE;
  DROP TABLE "pages_blocks_table_drawers_locales" CASCADE;`)
}
