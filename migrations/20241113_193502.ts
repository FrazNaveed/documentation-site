...
export async function down({ payload, req }: MigrateDownArgs): Promise<void> {
  ...
  ALTER TABLE "pages_blocks_brand_logo_roll_logos" DISABLE ROW LEVEL SECURITY;
  ALTER TABLE "pages_blocks_brand_logo_roll" DISABLE ROW LEVEL SECURITY;
  ALTER TABLE "pages_blocks_brand_logo_roll_locales" DISABLE ROW LEVEL SECURITY;
  DROP TABLE "pages_blocks_featured_news_carousel" CASCADE;
  DROP TABLE "pages_blocks_featured_news_carousel_locales" CASCADE;
  DROP TABLE "pages_blocks_brand_logo_roll_logos" CASCADE;
  DROP TABLE "pages_blocks_brand_logo_roll" CASCADE;
  DROP TABLE "pages_blocks_brand_logo_roll_locales" CASCADE;
