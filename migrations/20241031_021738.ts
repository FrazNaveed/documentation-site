...
export async function up({ payload, req }: MigrateUpArgs): Promise<void> {
  await payload.db.drizzle.execute(sql`
   CREATE TYPE IF NOT EXISTS "public"."enum_pages_blocks_talking_points_variation" AS ENUM('standard', 'wideList');
  CREATE TYPE IF NOT EXISTS "public"."enum_pages_blocks_two_column_layout" AS ENUM('default', 'reverse', 'even');
  CREATE TYPE IF NOT EXISTS "public"."enum_pages_blocks_two_column_column_one_content_type" AS ENUM('image', 'text');
  CREATE TYPE IF NOT EXISTS "public"."enum_pages_blocks_two_column_column_one_image_alignment" AS ENUM('center', 'left', 'right');
  CREATE TYPE IF NOT EXISTS "public"."enum_pages_blocks_two_column_column_one_image_fill" AS ENUM('contain', 'cover');
  CREATE TYPE IF NOT EXISTS "public"."enum_pages_blocks_two_column_column_two_content_type" AS ENUM('image', 'text');
  CREATE TYPE IF NOT EXISTS "public"."enum_pages_blocks_two_column_column_two_image_alignment" AS ENUM('center', 'left', 'right');
  CREATE TYPE IF NOT EXISTS "public"."enum_pages_blocks_two_column_column_two_image_fill" AS ENUM('contain', 'cover');
  ...
  CREATE TABLE IF NOT EXISTS "pastGrantsGrid_locales" (
  	"grid_title" varchar,
  	"link_text" varchar,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	CONSTRAINT "pastGrantsGrid_locales_locale_parent_id_unique" UNIQUE("_locale","_parent_id")
  );
...
export async function down({ payload, req }: MigrateDownArgs): Promise<void> {
  await payload.db.drizzle.execute(sql`
   CREATE TABLE IF NOT EXISTS "pages_blocks_past_f_grants_grid" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
