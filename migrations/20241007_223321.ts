...
export async function up({ payload, req }: MigrateUpArgs): Promise<void> {
  ...
  ALTER TABLE "pages_blocks_left_column_image" RENAME TO "pages_blocks_col_image";
  ALTER TABLE "pages_blocks_left_column_text" RENAME TO "pages_blocks_col_text";
  ALTER TABLE "pages_blocks_left_column_text_locales" RENAME TO "pages_blocks_col_text_locales";
  ALTER TABLE "pages_blocks_col_text_locales" DROP CONSTRAINT "pages_blocks_left_column_text_locales_locale_parent_id_unique";
  ALTER TABLE "pages_blocks_col_image" DROP CONSTRAINT "pages_blocks_left_column_image_image_id_media_id_fk";
  
  ALTER TABLE "pages_blocks_col_image" DROP CONSTRAINT "pages_blocks_left_column_image_parent_id_fk";
  
  ALTER TABLE "pages_blocks_col_text" DROP CONSTRAINT "pages_blocks_left_column_text_parent_id_fk";
  
  ALTER TABLE "pages_blocks_col_text_locales" DROP CONSTRAINT "pages_blocks_left_column_text_locales_parent_id_fk";
  
  DROP INDEX IF EXISTS "pages_blocks_left_column_image_order_idx";
  DROP INDEX IF EXISTS "pages_blocks_left_column_image_parent_id_idx";
  DROP INDEX IF EXISTS "pages_blocks_left_column_image_path_idx";
  DROP INDEX IF EXISTS "pages_blocks_left_column_text_order_idx";
  DROP INDEX IF EXISTS "pages_blocks_left_column_text_parent_id_idx";
  DROP INDEX IF EXISTS "pages_blocks_left_column_text_path_idx";
  ...
  DO $$ BEGIN
   ALTER TABLE "pages_blocks_col_text" ADD CONSTRAINT "pages_blocks_col_text_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "pages_blocks_col_text_locales" ADD CONSTRAINT "pages_blocks_col_text_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages_blocks_col_text"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  CREATE INDEX IF NOT EXISTS "pages_blocks_col_text_order_idx" ON "pages_blocks_col_text" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "pages_blocks_col_text_parent_id_idx" ON "pages_blocks_col_text" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "pages_blocks_col_text_path_idx" ON "pages_blocks_col_text" USING btree ("_path");
  ALTER TABLE "pages_blocks_col_text_locales" ADD CONSTRAINT "pages_blocks_col_text_locales_locale_parent_id_unique" UNIQUE("_locale","_parent_id");`)
}
...
export async function down({ payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "pages_blocks_col_text";
  DROP TABLE "pages_blocks_col_text_locales";
